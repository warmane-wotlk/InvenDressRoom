local widget, version = "TitleBorder", 1
...
LBO:RegisterWidget(widget, version, function(self, name)
	...
	self._top2:SetTexture(self._top0:GetTexture())
	self._top2:SetTexCoord(0.2578125, 1, 0.3671875, 1, 0.2578125, 0.0625, 0.3671875, 0.0625)
